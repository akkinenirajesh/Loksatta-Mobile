...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    mySplash = [[SplashView alloc]initWithImage:[UIImage imageNamed:@"bigicon.png"]];
    mySplash.animation = SplashViewAnimationFade;
    mySplash.touchAllowed=YES;
    mySplash.frame=CGRectMake(0, 0, 1024, 768);
    
    [_window insertSubview:mySplash atIndex:1];
    [_window makeKeyAndVisible];
    [_window addSubview:mySplash];
    [mySplash startSplash];
    [_window insertSubview:navController.view atIndex:0];
